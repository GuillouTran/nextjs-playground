...
function Reviews() {
      ...
      Pull request reviews<
          /h1>
            ...
            <p className="reviews-description">
              ...
              times people just send screenshots of their code, aside from being
  ...
  rel="noopener noreferrer nofollow"
                ...
                <li>
                  ...
                  Make sure to put your changes in a different branch from
                  <b>main</b>.
                </li>
  ...
  style = {
    { display: "inline", margin: 0 }
                ...
                <li>
                  ...
                  I'll try my best to give you constructive feedback and also
                  explain why you should make changes.
                </li>

                <li>
                  <span className="point">Rejection</span>
                  Keep in mind I'm doing this for <b>free</b> and I'm in a
                  position where I can refuse to review some pull requests.
                </li>
              </ul>
